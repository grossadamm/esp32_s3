...
export class AmazonFileImporter {
    ...
    async importFile(filePath, transactionType) {
        ...
        for (const row of records) {
            ...
            try {
                ...
                AmazonParsingUtils.logParsingError(transactionType, row, error, processed);
            }
        }
        // Log import
    ...
    async importDigitalOrders(dataPath) {
        ...
        for (const monetary of monetaryRecords) {
            ...
            try {
                ...
                AmazonParsingUtils.logParsingError('digital_monetary', monetary, error, processed);
            }
        }
    ...
    async importSingleFileType(dataPath, relativeFilePath, transactionType) {
    ...
    getDisplayNameForTransactionType(transactionType) {
        switch (transactionType) {
